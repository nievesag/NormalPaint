...
func _ready():
	...
	_compute(storage_buffer, texture, texture_1)

func _compute(storage_buffer: RID, texture: RID, texture_1: RID):
	...
	var uniform_set := rd.uniform_set_create([parameter_uniform, image_uniform, image_uniform_1], shader, 0)
